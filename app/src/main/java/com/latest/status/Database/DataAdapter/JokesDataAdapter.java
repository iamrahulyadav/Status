...
import com.latest.status.Database.DBHelper.JokesDBHelper;
...
public class JokesDataAdapter {

    private JokesDBHelper mDBHelper;
    private Context context;

    public JokesDataAdapter(Context context) {
        this.context = context;
    }

    public void openDB() {
        mDBHelper = new JokesDBHelper(context);
